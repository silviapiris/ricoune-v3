...
const photos = [
  ...
  { id: "p16",  src: `${BASE}/3O8A5554-800x875.jpg`,                          alt: "Ricoune au micro",           objectPosition: "object-center" },
  { id: "p17",  src: `${BASE}/3O8A8962-800x592.jpg`,                          alt: "Ambiance concert Ricoune" },
  { id: "p18",  src: `${BASE}/3O8A5428-786x1000.jpg`,                         alt: "Ricoune en concert",         objectPosition: "object-center" },
  { id: "p19",  src: `${BASE}/3O8A5692-765x1000.jpg`,                         alt: "Portrait de Ricoune",        objectPosition: "object-center" },
  { id: "p20",  src: `${BASE}/3O8A8945-800x822.jpg`,                          alt: "Ricoune sur scène",          objectPosition: "object-center" },
  ...
  { id: "p23",  src: `${BASE}/3O8A5449-800x910.jpg`,                          alt: "Portrait Ricoune",           objectPosition: "object-center" },
  { id: "p24",  src: `${BASE}/3O8A8715-667x1000.jpg`,                         alt: "Ricoune au micro",           objectPosition: "object-center" },
  { id: "p25",  src: `${BASE}/3O8A5562-664x1000.jpg`,                         alt: "Ricoune en concert",         objectPosition: "object-center" },
  ...
  { id: "p29",  src: `${BASE}/3O8A8974-721x1000.jpg`,                         alt: "Portrait de Ricoune",        objectPosition: "object-center" },
  { id: "p30",  src: `${BASE}/3O8A8725-800x962.jpg`,                          alt: "Ricoune au micro",           objectPosition: "object-center" },
  { id: "p31",  src: `${BASE}/3O8A8863-800x969.jpg`,                          alt: "Ricoune en concert",         objectPosition: "object-center" },
  ...
  { id: "p35",  src: `${BASE}/3O8A8722-800x968.jpg`,                          alt: "Portrait Ricoune",           objectPosition: "object-center" },
];
