      ...
      <ul className="space-y-2">
        {FOOTER_NAV_LINKS.map((link) => (
          <li key={link.href}>
            <Link
              href={link.href}
              className="text-sm text-rc-white/70 transition-colors duration-200 hover:text-rc-white"
            >
              {link.label}
            </Link>
          </li>
      ...
      <div className="flex items-center gap-4">
        {SOCIAL_LINKS.map((social) => (
          <a
            ...
            className="text-rc-white transition-colors duration-200 hover:text-rc-yellow"
...
export default function Footer() {
  return (
    <footer
      className="mt-auto"
      style={{ background: "rgba(26, 34, 68, 0.4)" }}
    >
