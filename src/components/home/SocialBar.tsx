        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 py-2">
          {SOCIAL_LINKS.map((social) => (
            <a
              ...
              className="rc-card flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1.5 sm:px-4 sm:py-2 text-sm font-medium text-white transition-opacity hover:opacity-80"
