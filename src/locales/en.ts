...
export const en: Translations = {
  ...
  biography: {
    ...
    timeline: [
      ...
      { year: "1993", description: "The band becomes \"Ricoune et les Counass\"" },
      { year: "1994", description: "First album \"Le Chat de Jourdan\"" },
      { year: "2001", description: "Adopts the stage name \"Ricoune\" + album \"Sans interdits\"" },
      { year: "2013", description: "Album \"Accent du Sud\" + hit \"Dans un verre à ballon\"" },
      { year: "2016", description: "\"Le Best Of, 20 ans\" (career anniversary)" },
      ...
      { year: "2025", description: "Tour of southern French ferias (Béziers + villages)" },
    ],type { Translations } from "./fr";
